...
class AppKafkaConfig(
    ...
    val kafkaTopicOutV1: String = KAFKA_TOPIC_OUT_V1,
        ...
        companion object {
            ...
            val KAFKA_GROUP_ID by lazy { System.getenv(KAFKA_GROUP_ID_VAR) ?: "accounting" }
            val KAFKA_TOPIC_IN_V1 by lazy { System.getenv(KAFKA_TOPIC_IN_V1_VAR) ?: "accounting-in-v1" }
            val KAFKA_TOPIC_OUT_V1 by lazy { System.getenv(KAFKA_TOPIC_OUT_V1_VAR) ?: "accounting-out-v1" }
        }
}